void basic_analysis_func_v2(int runn, const char* file = "")
{

  //TFile *fi = new TFile("/home/wcte/data_root/root_run_000236.root");
  ...
  for(int i=0; i<stop_event; i++){
    ...
    if(scint1 && scint2) {
      ...
      else if(!(gct1Signal || gct2Signal) && (sci2Time-sci1Time)<1000.) actPeakOther->Fill(actPeak);
