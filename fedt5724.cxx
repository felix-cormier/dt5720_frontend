...
const char BankName[N_DT5724][5]={"D720"};
...
const char *frontend_name = "feDT5720";
...
INT frontend_init()
{
  ...
  sprintf(set_str, "/Equipment/feDT5720/Settings/DT5720");
...
INT initialize_for_run(){
	...
	//CAEN_DGTZ_SetChannelSelfTrigger(handle,CAEN_DGTZ_TRGMODE_ACQ_ONLY,0);
